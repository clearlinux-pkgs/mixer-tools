...
Version  : 5.1.1
Release  : 102
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v5.1.1/mixer-tools-5.1.1.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v5.1.1/mixer-tools-5.1.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1534488189
make  %{?_smp_mflags}
