...
Version  : 6.2.10
Release  : 193
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v6.2.10/mixer-tools-6.2.10.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v6.2.10/mixer-tools-6.2.10.tar.gz
...
%prep
%setup -q -n mixer-tools-6.2.10
cd %{_builddir}/mixer-tools-6.2.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661884165
