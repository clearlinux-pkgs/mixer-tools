...
Version  : 4.3.3
Release  : 77
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v4.3.3/mixer-tools-4.3.3.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v4.3.3/mixer-tools-4.3.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1524241364
make  %{?_smp_mflags}
