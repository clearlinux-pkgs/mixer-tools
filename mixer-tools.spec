...
Version  : 6.1.6
Release  : 152
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v6.1.6/mixer-tools-6.1.6.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v6.1.6/mixer-tools-6.1.6.tar.gz
...
%prep
%setup -q -n mixer-tools-6.1.6
cd %{_builddir}/mixer-tools-6.1.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578888517
...
cp %{_builddir}/mixer-tools-6.1.6/COPYING %{buildroot}/usr/share/package-licenses/mixer-tools/598f87f072f66e2269dd6919292b2934dbb20492
cp %{_builddir}/mixer-tools-6.1.6/vendor/github.com/BurntSushi/toml/COPYING %{buildroot}/usr/share/package-licenses/mixer-tools/f9cab757896ef6b3570e62b2df7fb63ab1a34b80
cp %{_builddir}/mixer-tools-6.1.6/vendor/github.com/go-ini/ini/LICENSE %{buildroot}/usr/share/package-licenses/mixer-tools/e4ef54f2c30670f950d5e196afa09c88d8ef0c8a
cp %{_builddir}/mixer-tools-6.1.6/vendor/github.com/inconshreveable/mousetrap/LICENSE %{buildroot}/usr/share/package-licenses/mixer-tools/9174f93c54ad0022bbb9b445480cfb6b4217226a
cp %{_builddir}/mixer-tools-6.1.6/vendor/github.com/mattn/go-runewidth/LICENSE %{buildroot}/usr/share/package-licenses/mixer-tools/5ca808f075931c5322193d4afd5a3370c824f810
cp %{_builddir}/mixer-tools-6.1.6/vendor/github.com/olekukonko/tablewriter/LICENSE.md %{buildroot}/usr/share/package-licenses/mixer-tools/7c15369a8295c6d2cd26b41618f5ba81e7e06eca
cp %{_builddir}/mixer-tools-6.1.6/vendor/github.com/pkg/errors/LICENSE %{buildroot}/usr/share/package-licenses/mixer-tools/9c1bedc0d42f24c24a1bd266f3ce101a4b0579fc
cp %{_builddir}/mixer-tools-6.1.6/vendor/github.com/spf13/cobra/LICENSE.txt %{buildroot}/usr/share/package-licenses/mixer-tools/c7feacb4667f8c63c89e2eeeb9a913bd3ced8ac2
cp %{_builddir}/mixer-tools-6.1.6/vendor/github.com/spf13/pflag/LICENSE %{buildroot}/usr/share/package-licenses/mixer-tools/b3c86ae465b21f7323059db335158b48187731c7
%make_install
