...
Version  : 5.2.0
Release  : 121
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v5.2.0/mixer-tools-5.2.0.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v5.2.0/mixer-tools-5.2.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1536360952
make  %{?_smp_mflags}
