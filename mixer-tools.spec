...
Version  : 4.5.2
Release  : 84
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v4.5.2/mixer-tools-4.5.2.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v4.5.2/mixer-tools-4.5.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1526672239
make  %{?_smp_mflags}
