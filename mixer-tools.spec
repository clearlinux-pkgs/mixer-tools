...
Version  : 4.1.2
Release  : 70
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v4.1.2/mixer-tools-4.1.2.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v4.1.2/mixer-tools-4.1.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1521132030
make  %{?_smp_mflags}
