...
Version  : 6.3.4
Release  : 223
URL      : https://github.com/clearlinux/mixer-tools/archive/refs/tags/v6.3.4.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/archive/refs/tags/v6.3.4.tar.gz
...
%prep
%setup -q -n mixer-tools-6.3.4
cd %{_builddir}/mixer-tools-6.3.4
pushd ..
cp -a mixer-tools-6.3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708029571
