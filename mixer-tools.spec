...
Version  : 4.6.6
Release  : 94
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v4.6.6/mixer-tools-4.6.6.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v4.6.6/mixer-tools-4.6.6.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1530315883
make  %{?_smp_mflags}
