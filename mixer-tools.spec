...
Version  : 4.2.0
Release  : 71
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v4.2.0/mixer-tools-4.2.0.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v4.2.0/mixer-tools-4.2.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1521742805
make  %{?_smp_mflags}
