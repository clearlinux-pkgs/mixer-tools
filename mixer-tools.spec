...
Version  : 4.6.7
Release  : 95
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v4.6.7/mixer-tools-4.6.7.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v4.6.7/mixer-tools-4.6.7.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1530919465
make  %{?_smp_mflags}
