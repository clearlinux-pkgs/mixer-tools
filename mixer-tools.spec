...
Version  : 5.1.0
Release  : 101
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v5.1.0/mixer-tools-5.1.0.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v5.1.0/mixer-tools-5.1.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1534106223
make  %{?_smp_mflags}
