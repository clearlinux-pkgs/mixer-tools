...
Version  : 5.0.1
Release  : 99
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v5.0.1/mixer-tools-5.0.1.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v5.0.1/mixer-tools-5.0.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1532628144
make  %{?_smp_mflags}
