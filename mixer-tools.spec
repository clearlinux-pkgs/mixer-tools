...
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v4.0.3/mixer-tools-4.0.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1520533952
make  %{?_smp_mflags}
