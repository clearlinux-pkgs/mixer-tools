...
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v3.06/mixer-tools-3.06.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1502315013
