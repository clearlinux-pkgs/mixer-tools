...
Version  : 4.6.3
Release  : 89
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v4.6.3/mixer-tools-4.6.3.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v4.6.3/mixer-tools-4.6.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1528757140
make  %{?_smp_mflags}
