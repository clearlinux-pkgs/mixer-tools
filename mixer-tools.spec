...
Version  : 4.5.3
Release  : 85
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v4.5.3/mixer-tools-4.5.3.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v4.5.3/mixer-tools-4.5.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1527143384
make  %{?_smp_mflags}
