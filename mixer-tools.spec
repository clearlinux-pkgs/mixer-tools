...
Version  : 5.1.2
Release  : 103
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v5.1.2/mixer-tools-5.1.2.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v5.1.2/mixer-tools-5.1.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1534843039
make  %{?_smp_mflags}
