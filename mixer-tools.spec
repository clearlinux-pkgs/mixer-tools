...
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v4.5.1/mixer-tools-4.5.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1526345279
make  %{?_smp_mflags}
