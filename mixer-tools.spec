...
Version  : 4.3.0
Release  : 73
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v4.3.0/mixer-tools-4.3.0.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v4.3.0/mixer-tools-4.3.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1523566529
make  %{?_smp_mflags}
