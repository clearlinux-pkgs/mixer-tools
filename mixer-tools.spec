...
Version  : 6.2.7
Release  : 188
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v6.2.7/mixer-tools-6.2.7.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v6.2.7/mixer-tools-6.2.7.tar.gz
...
%prep
%setup -q -n mixer-tools-6.2.7
cd %{_builddir}/mixer-tools-6.2.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660001776
