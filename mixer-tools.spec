...
Version  : 4.7.0
Release  : 96
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v4.7.0/mixer-tools-4.7.0.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v4.7.0/mixer-tools-4.7.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1532125390
make  %{?_smp_mflags}
