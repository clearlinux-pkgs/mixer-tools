...
Version  : 4.6.0
Release  : 86
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v4.6.0/mixer-tools-4.6.0.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v4.6.0/mixer-tools-4.6.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1527882869
make  %{?_smp_mflags}
