...
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v6.2.11/mixer-tools-6.2.11.tar.gz
...
%prep
%setup -q -n mixer-tools-6.2.11
cd %{_builddir}/mixer-tools-6.2.11
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661916373
