...
Version  : 5.2.2
Release  : 124
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v5.2.2/mixer-tools-5.2.2.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v5.2.2/mixer-tools-5.2.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1538107501
make  %{?_smp_mflags}
