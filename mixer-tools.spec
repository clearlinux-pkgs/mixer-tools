...
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v4.6.1/mixer-tools-4.6.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1528334176
make  %{?_smp_mflags}
