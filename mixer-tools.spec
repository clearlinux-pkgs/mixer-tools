...
Version  : 4.2.1
Release  : 72
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v4.2.1/mixer-tools-4.2.1.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v4.2.1/mixer-tools-4.2.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1522778889
make  %{?_smp_mflags}
