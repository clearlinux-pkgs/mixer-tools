...
Version  : 6.2.12
Release  : 195
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v6.2.12/mixer-tools-6.2.12.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v6.2.12/mixer-tools-6.2.12.tar.gz
...
%prep
%setup -q -n mixer-tools-6.2.12
cd %{_builddir}/mixer-tools-6.2.12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662058645
