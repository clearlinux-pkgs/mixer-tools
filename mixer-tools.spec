...
Version  : 4.1.1
Release  : 69
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v4.1.1/mixer-tools-4.1.1.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v4.1.1/mixer-tools-4.1.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1520966741
make  %{?_smp_mflags}
