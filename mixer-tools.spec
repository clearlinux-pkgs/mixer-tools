...
Version  : 5.0.2
Release  : 100
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v5.0.2/mixer-tools-5.0.2.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v5.0.2/mixer-tools-5.0.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1533063876
make  %{?_smp_mflags}
