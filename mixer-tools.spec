...
Version  : 4.4.0
Release  : 79
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v4.4.0/mixer-tools-4.4.0.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v4.4.0/mixer-tools-4.4.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1525463229
make  %{?_smp_mflags}
