...
Version  : 6.2.9
Release  : 192
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v6.2.9/mixer-tools-6.2.9.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v6.2.9/mixer-tools-6.2.9.tar.gz
...
%prep
%setup -q -n mixer-tools-6.2.9
cd %{_builddir}/mixer-tools-6.2.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661555496
