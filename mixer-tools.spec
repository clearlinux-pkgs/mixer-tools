...
Version  : 4.1.0
Release  : 68
URL      : https://github.com/clearlinux/mixer-tools/releases/download/v4.1.0/mixer-tools-4.1.0.tar.gz
Source0  : https://github.com/clearlinux/mixer-tools/releases/download/v4.1.0/mixer-tools-4.1.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1520626528
make  %{?_smp_mflags}
